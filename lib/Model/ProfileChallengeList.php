...
/**
 * ProfileChallengeList Class Doc Comment
 *
 * @category Class
 * @package  WeFitter\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProfileChallengeList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProfileChallengeList';
...
'leaderboard_score' => 'setLeaderboardScore',
...
self::REPETITION_STICKTOIT,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['leaderboard_score'] = isset($data['leaderboard_score']) ? $data['leaderboard_score'] : null;
     ...
     *
     * @param int $leaderboard_rank Current or final rank among the participants of the challenge as determined by the relevant score.
     *
     * @return $this
     */
    ...
    /**
     * Gets leaderboard_score
     *
     * @return float
     */
    public function getLeaderboardScore()
    {
        return $this->container['leaderboard_score'];
    }

    /**
     * Sets leaderboard_score
     *
     * @param float $leaderboard_score The profile's current or final score.
     *
     * @return $this
     */
    public function setLeaderboardScore($leaderboard_score)
    {
        $this->container['leaderboard_score'] = $leaderboard_score;
     ...
     *
     * @param bool $is_participating Does the current profile participate in this challenge?
     *
     * @return $this
     */
